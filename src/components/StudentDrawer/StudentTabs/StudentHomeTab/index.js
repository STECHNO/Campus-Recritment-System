  ...
  return (
    <View style={styles.mainContainer}>
      <View style={styles.welcome}>
        {props.aut.profileData.firstName != '' && (
          <View style={{ alignItems: 'center' }} >
            <Text style={{ color: 'blue', fontSize: 30 }}>Student Dashboard</Text>
      ...
      <View style={styles.cardsContainer}>
        ...
        {(props.app.jobs.length != 0) && (<Text style={{ fontSize: 35, fontWeight: 'bold', color: 'blue' }} >{props.app.jobs.length}</Text>)}
      </View>
...
export default connect(mapStateToProps, mapDispatchToProps)(StudentHomeTab);